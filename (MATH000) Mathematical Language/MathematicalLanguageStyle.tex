...
% Page typography: stay close to the Science Quiz handbook rather than
% compressing the document into a reference sheet.
\setlength{\parskip}{0pt}
\setlength{\parindent}{1.5em}
\linespread{1.0}

% Table columns and spacing. This deliberately follows the Science Quiz
% Notation and Conventions chapter: broad two-column tables, small text,
% booktabs rules, and moderate row spacing.
...
% Contents: readable, not forced into an artificially compact block.
...
% Lightweight Parts: structural markers only, never standalone pages.
\newcounter{mathpart}
...
% Section hierarchy: close to the handbook's restrained section scale.
\titleformat{\section}
  {\large\bfseries}
  {\thesection}
  {0.72em}
  {}
\titlespacing*{\section}{0pt}{1.38em}{0.60em}
\pretocmd{\section}{\Needspace{5\baselineskip}}{}{}

% Subsections remain available for future course documents but are intentionally
% not used for routine grouping in this document.
...
% Running identity. The left header is intentionally stable across pages.
\pagestyle{fancy}
\fancyhf{}
