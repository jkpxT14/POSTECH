...
%
% Design baseline: the MATH200 Mathematical Concepts / Past Problems document family,
% adapted for a compact reference document. Institution colors are reserved for institution names only.
...
% Contradiction symbol used in proofs.  The glyph is taken from the
% St Mary Road symbol font without loading its full math-symbol family.
\DeclareFontFamily{U}{stmry}{}
\DeclareFontShape{U}{stmry}{m}{n}{<-> stmary10}{}
\newcommand{\lightning}{\mathord{\text{\usefont{U}{stmry}{m}{n}\char32}}}
\usepackage{xcolor}
\usepackage{array}
\usepackage{booktabs}
...
\DeclareMathOperator{\IdealNorm}{N}
...
% Map arrows
% A bijection combines the standard injective hook with the standard surjective
% double arrowhead. \joinrel joins the two relation glyphs without ad hoc spacing.
...
\newpagestyle{mathlanguage}{%
  \sethead{\small\textit{(MATH000) Mathematical Language}}{}{\small\textit{\sectiontitle}}%
  \setfoot{}{\small\thepage}{}%
  \setheadrule{0.4pt}%
}
\pagestyle{mathlanguage}
