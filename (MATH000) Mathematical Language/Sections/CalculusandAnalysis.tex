...
$\displaystyle\lim_{x\to a} f(x)=\infty,\ \lim_{x\to a} f(x)=-\infty$ & Infinite limits. \\
$\min A$ & Minimum of $A$. \\*
$\max A$ & Maximum of $A$. \\
$\inf A$ & Infimum of $A$. \\*
$\sup A$ & Supremum of $A$. \\
...
$D_{\mathbf v}f(\mathbf a),\ \partial_{\mathbf v}f(\mathbf a)$ & Directional derivative of $f$ at $\mathbf a$ in the direction $\mathbf v$; when $f$ is differentiable, $D_{\mathbf v}f(\mathbf a)=Df(\mathbf a)\mathbf v=\nabla f(\mathbf a)\cdot\mathbf v$. \\
...
$P=\{x_0,\dots,x_n\},\ a=x_0<\cdots<x_n=b$ & Partition of the interval $[a,b]$. \\
$\displaystyle\sum_{i=1}^n f(\xi_i)\Delta x_i,\quad \Delta x_i=x_i-x_{i-1}$ & Tagged Riemann sum, with $\xi_i\in[x_{i-1},x_i]$. \\
...
$J_{\mathbf F}(\mathbf a),\ \det D\mathbf F(\mathbf a),\ \Jac\mathbf F(\mathbf a)$ & Jacobian determinant of $\mathbf F$ at $\mathbf a$, in preferred order. \\
...
$|\alpha|=\alpha_1+\cdots+\alpha_n,\quad \alpha!=\alpha_1!\cdots\alpha_n!$ & Order and factorial of a multi-index. \\
