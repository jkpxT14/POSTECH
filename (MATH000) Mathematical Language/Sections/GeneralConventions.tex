...
Large operators & Display size in displayed mathematics and notation tables; limits are placed above and below when appropriate. \\
...
\addlinespace[0.26em]
$a=b$ & Equality. \\
$a\coloneqq b,\ a:=b$ & $a$ is defined to be $b$. \\
