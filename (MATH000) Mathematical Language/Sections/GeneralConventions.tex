...
Fields & Arbitrary or named fields are denoted by ordinary italic uppercase letters such as $F,K,L$. Blackboard bold is reserved for established number systems and standard finite-field notation such as $\mathbb{F}_q$. \\
...
Greek variants & Distinct typographic variants of Greek letters are treated as distinct symbols, not as interchangeable forms of the same symbol. For example, $\varepsilon$ and $\epsilon$, and $\varphi$ and $\phi$, are distinct unless explicitly identified otherwise. \\
\end{ruletable}

\begin{notationtable}
$(a_1,\dots,a_n)$ & Ordered tuple. \\
$(a_n),\ (a_n)_{n\ge1}$ & Sequence; an appropriate natural-number index set may be displayed when useful. \\
$(a_i)_{i\in I}$ & Indexed family over an arbitrary index set $I$. \\
$(a,b)$ & Open interval. \\*
$[a,b]$ & Closed interval. \\*
