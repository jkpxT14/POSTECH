...
Enumeration styles indicate the structural role of the listed items.

\begin{ruletable}
$1.1,1.2,1.3,\dots$ & Independent subproblems or standalone units under a common parent. \\
$(1),(2),(3),\dots$ & Parallel items, such as choices, cases, statements, assumptions, or procedural steps. \\
$(a),(b),(c),\dots$ & Subparts of a single problem sharing a common setup. \\
$(i),(ii),(iii),\dots$ & Formal clauses, conditions, properties, or equivalent statements in definitions, theorems, and related statements. \\
\end{ruletable}

Nested enumeration follows the same roles; for example, a subpart $(a)$ may contain formal clauses $(i),(ii),\dots$.
