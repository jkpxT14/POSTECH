...
$\F_q,\ \operatorname{GF}(q)$ & Finite field with $q$ elements, where $q$ is a prime power; $\F_q$ is preferred. \\
\addlinespace[0.35em]
...
$\displaystyle(f\star g)(n)=\sum_{d\mid n}f(d)g(n/d)$ & Dirichlet convolution of arithmetic functions $f$ and $g$. \\
