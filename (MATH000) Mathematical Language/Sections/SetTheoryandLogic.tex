...
$A\triangle B,\ A\mathbin{\Delta}B$ & Symmetric difference; $A\triangle B$ is preferred. \\
...
\addlinespace[0.35em]
$|A|,\ \#A$ & Cardinality; $|A|$ is preferred, while $\#A$ is a common alternative, especially when emphasizing the number of elements. \\
