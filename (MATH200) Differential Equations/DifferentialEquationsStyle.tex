% Shared style for (MATH200) Differential Equations.
...
% Differential-equations notation copied locally from the current MATH000 standard.
...
\newcommand{\CourseOpening}[1]{%
  ...
  {\noindent\fontsize{18.5}{22}\selectfont\bfseries
    (MATH200) Differential Equations\par}%
  \vspace{0.12cm}%
...
\newcommand{\CourseDocumentType}{Differential Equations}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\textit{(MATH200) Differential Equations}}
