    ...
    \begin{expectedproblem}[1964 IMO]
        ...
        are three people such that every pair among them discusses the same
        topic.
    \end{expectedproblem}
    ...
    \begin{expectedproblem}[Integer-Side Rectangle Tiling Theorem]
    ...
    \begin{expectedproblem}[Tournament King Theorem]
        ...
        directed edge. Prove that there is a vertex $A$ such that every other
    ...
    \begin{solution}
        ...
        Therefore, for every $B$ that defeats $A$, there is a vertex $C$ such
        that $A$ defeats $C$ and $C$ defeats $B$. Hence $A$ is a king.
    \end{solution}
    ...
    \begin{expectedproblem}[2005 Putnam]
        Find a nonzero polynomial $P(x,y)$ in two variables such that
        \[
    ...
    \begin{expectedproblem}[2002 AIME I]
        Let $S$ be a set of distinct positive integers such that
        \[
            1\in S,
            \qquad
            \max S=2002.
    ...
    \begin{expectedproblem}[2012 Putnam]
        ...
        distinct indices $i,j,k$ such that $d_i,d_j,d_k$ are the side lengths
    ...
    \begin{expectedproblem}[2022 \POSTECH{} Science Quiz Preparation]
    ...
    \begin{expectedproblem}[Adapted from 2022 \POSTECH{} Science Quiz Preparation]
        ...
        Determine:
        \begin{enumerate}
            \item[(a)] which functions are entire;
            \item[(b)] which function is meromorphic on $\C$ but not entire;
            \item[(c)] which function is not holomorphic on any nonempty open
                      subset of $\C$.
        \end{enumerate}
    \end{expectedproblem}
    ...
    \begin{expectedproblem}[2022 \POSTECH{} Science Quiz Preparation]
        ...
        or false.
        \begin{enumerate}
            \item[(i)] There exists a perfect subset of $\R$ containing no
                       nondegenerate interval.
            \item[(ii)] The set $\Z$ is open.
            \item[(iii)] The set $\Z$ is closed.
            \item[(iv)] There exists a countable subset of $\R$ that is neither
                        open nor closed.
        \end{enumerate}
    \end{expectedproblem}
    ...
    \begin{solution}
        ...
        (i) is true. The set $\Z$ is not open, because no open interval centered
        at an integer lies inside $\Z$, but it is closed because
        $\R\setminus\Z$ is open. Hence (ii) is false and (iii) is true. Finally,
        $\Q$ is countable and is neither open nor closed in $\R$, so (iv) is
        true. Therefore,
        \[
            \boxed{\text{(i) T,\quad (ii) F,\quad (iii) T,\quad (iv) T}}.
        \]
    \end{solution}
    ...
    \begin{expectedproblem}[Series]
        ...
        \begin{expectedsubproblem}[Inverse Central Binomial Sum]
            Determine
            \[
                \sum_{n=1}^{\infty}
        ...
        \begin{expectedsubproblem}[2022 \POSTECH{} Science Quiz Preparation]
            Evaluate
            \[
    ...
    \begin{expectedproblem}[2022 \POSTECH{} Science Quiz Preparation]
        ...
        \[
            \begin{array}{c}
                p\text{-adic geometry},\\
                \text{boundedness of Fano varieties and the BAB conjecture},\\
    ...
    \begin{expectedproblem}[Adapted from 2022 \POSTECH{} Science Quiz Preparation]
        ...
        \[
            \begin{array}{cc}
                \text{Rota's conjecture},
                &
                \text{Mason's conjecture},
                \\[0.3em]
                \text{Dowling--Wilson conjecture},
                &
                \text{Sullivan conjecture}.
            \end{array}
        \]
    \end{expectedproblem}
        ...
        \[
            \boxed{
                \begin{aligned}
                    ...
                    \text{Vietnam}
                    &\longleftrightarrow \text{Ng\^o B\`ao Ch\^au}.
                \end{aligned}
            }
        \]
    \end{solution}

    \begin{expectedproblem}[Inspired by 2022 \POSTECH{} Science Quiz Preparation]
    ...
    \begin{solution}
        The 2026 Abel Prize laureate is
        \[
    ...
    \begin{expectedproblem}[2022 \POSTECH{} Science Quiz Preparation]
        ...
        \[
            \begin{array}{cc}
                \text{Guillaume de l'H\^opital},
                &
                \text{Isaac Newton},
                \\
                \text{Gottfried Wilhelm Leibniz},
                &
                \text{Colin Maclaurin}.
            \end{array}
        \]
    ...
    \begin{expectedproblem}[Adapted from 2022 \POSTECH{} Science Quiz Preparation]
        ...
        associated with its introduction or early systematic development:
        \[
            \begin{array}{c}
                \text{quaternions},\qquad
                p\text{-adic numbers},\qquad
                \text{hyperreal numbers},\qquad
                \text{surreal numbers}
            \end{array}
        \]
        and
    ...
    \begin{expectedproblem}[Adapted from 2022 \POSTECH{} Science Quiz Preparation]
        ...
        \begin{enumerate}
            \item[(a)] Among $23$ people, a shared birthday has probability
                       greater than $1/2$.
            \item[(b)] Alternating two losing games can create a winning game.
            \item[(c)] A ball can be reassembled into two congruent copies using
                       finitely many nonmeasurable pieces.
            \item[(d)] Dominance reasoning and expected utility reasoning
                       recommend different choices when a highly accurate
                       predictor has already filled two boxes.
        \end{enumerate}
    \end{expectedproblem}
    ...
    \begin{solution}
        ...
        \[
            ...
            S_k=\sum_{i=1}^{k}d_i.
        \]
        Choose $j\in\{0,1,\ldots,n-1\}$ such that $S_j$ is minimal, and start
    ...
    \begin{expectedproblem}[1996 Putnam]
        ...
        two squares may not overlap. Determine the least number $A$ such that
