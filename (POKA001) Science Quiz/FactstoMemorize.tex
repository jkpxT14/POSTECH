    ...
    \begin{remark}
        ...
        proof that Gerver's construction is optimal. At the 2026 preparation
        cutoff, the result remained a preprint, so its publication status should
    ...
    \begin{fact}[Cycle Double Cover Conjecture: 2026 Status]
        ...
        form. At the preparation cutoff, the result should be remembered as an
        announced and publicly exposited proof rather than silently conflated
