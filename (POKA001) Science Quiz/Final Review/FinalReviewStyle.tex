...
\newcommand{\FinalOpening}{%
  ...
  {\noindent\footnotesize\color{SoftGray}
    \textit{Mathematics for Science Quiz}, 2026 Science War Edition을 바탕으로 2026년 9월 17일까지 최종 정리.\par
    PPTX 36문항, Problem sets 90문항, Past Problems 103문항의 전수 점검을 반영하고, 주요 기출 35문항을 Part IV에 선별 수록.}
  \thispagestyle{empty}%
  \clearpage
  \pagestyle{fancy}%
