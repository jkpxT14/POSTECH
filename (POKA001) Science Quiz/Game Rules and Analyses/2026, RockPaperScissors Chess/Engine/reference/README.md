...
These files exist to make the 55%+ engine-strength gate auditable; the production Analysis Board is the HTML file at the project root and the native engine source is in `../src/`.
