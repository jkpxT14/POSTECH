\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[x=0.620cm,y=0.620cm]
        ...
        \node[rpsc analysis text] at (5.50,10.50) {S};
        \node[rpsc analysis text] at (4.50,9.50) {RP};
        \node[rpsc analysis text] at (5.50,9.50) {R};
        \node[rpsc analysis text] at (6.50,9.50) {RP};
        \node[rpsc analysis text compact] at (3.50,8.50) {SRP};
        \node[rpsc analysis text] at (4.50,8.50) {SP};
        \node[rpsc analysis text compact] at (5.50,8.50) {SRP};
        \node[rpsc analysis text] at (6.50,8.50) {SP};
        ...
        \node[rpsc analysis text] at (1.50,6.50) {SP};
        \node[rpsc analysis text] at (2.50,6.50) {SP};
        \node[rpsc analysis text compact] at (3.50,6.50) {SRP};
        \node[rpsc analysis text] at (4.50,6.50) {SP};
        \node[rpsc analysis text compact] at (5.50,6.50) {SRP};
        \node[rpsc analysis text] at (6.50,6.50) {SP};
        \node[rpsc analysis text compact] at (7.50,6.50) {SRP};
        \node[rpsc analysis text] at (8.50,6.50) {SP};
        \node[rpsc analysis text] at (9.50,6.50) {SP};
        \node[rpsc analysis text] at (0.50,5.50) {R};
        \node[rpsc analysis text] at (1.50,5.50) {R};
        ...
        \node[rpsc analysis text] at (6.50,4.50) {SP};
        \node[rpsc analysis text compact] at (7.50,4.50) {SRP};
        \node[rpsc analysis text] at (8.50,4.50) {SP};
        \node[rpsc analysis text] at (9.50,4.50) {SP};
        ...
        \node[rpsc analysis text] at (4.50,2.50) {SP};
        \node[rpsc analysis text compact] at (5.50,2.50) {SRP};
        \node[rpsc analysis text] at (6.50,2.50) {SP};
        \node[rpsc analysis text compact] at (7.50,2.50) {SRP};
        \node[rpsc analysis text] at (4.50,1.50) {RP};
        \node[rpsc analysis text] at (5.50,1.50) {R};
        \node[rpsc analysis text] at (6.50,1.50) {RP};
        \node[rpsc analysis text] at (5.50,0.50) {S};
    \end{tikzpicture}
    \caption{Paper with Rotation}
    \label{fig:paper-rotation}
\end{figure}
