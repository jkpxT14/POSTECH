\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[x=0.620cm,y=0.620cm]
        ...
        \node[rpsc analysis text] at (6.50,12.50) {P};
        \node[rpsc analysis text] at (5.50,11.50) {SR};\node[rpsc analysis text] at (7.50,11.50) {SR};
        ...
        \node[rpsc analysis text] at (5.50,1.50) {SR};\node[rpsc analysis text] at (7.50,1.50) {SR};
        \node[rpsc analysis text] at (6.50,0.50) {P};
    \end{tikzpicture}
    \caption{Paper with Step}
    \label{fig:paper-step}
\end{figure}
