\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[x=0.620cm,y=0.620cm]
        ...
        \node[rpsc analysis text] at (0.50,4.50) {P};
        \node[rpsc analysis text] at (2.50,4.50) {SR};
        \node[rpsc analysis text] at (4.50,4.50) {S};
        \node[rpsc analysis text] at (6.50,4.50) {SR};
        \node[rpsc analysis text] at (8.50,4.50) {P};
        \node[rpsc analysis text compact] at (1.50,3.50) {SRP};
        ...
        \node[rpsc analysis text compact] at (3.50,1.50) {SRP};
        \node[rpsc analysis text compact] at (5.50,1.50) {SRP};
        \node[rpsc analysis text] at (4.50,0.50) {R};
    \end{tikzpicture}
    \caption{Scissors with Push}
    \label{fig:scissors-push}
\end{figure}
