...
Analysis Board의 \texttt{.rpsc} 파일은 진행 중인 확정 상태에서도 저장할 수 있다. \texttt{Q[1,1]} 또는 \texttt{Q[0,0]} 뒤에 이동이 없으면 White 이동 전, White의 Move Notation만 있으면 Black 이동 전 상태를 뜻한다. 한 학교만 정답인 경우에는 정답 학교의 Item Choice가 남아 있을 수 있다.
