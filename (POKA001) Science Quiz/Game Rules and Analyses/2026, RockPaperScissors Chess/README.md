...
The six handbook games are regression-replayed under the current rules: all 120 quiz rows, item-role mappings, move paths, captures, resets, and the fixed score/quiz/capture totals are checked by the bundled test suite.
...
- `Engine/`: native C++17 RPSC Engine 0.22.0, source, tests, and paired self-play harness.
