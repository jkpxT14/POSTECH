    ...
    current through September 13, 2026. Unlike Part II, which collects durable facts
    ...
    \begin{fact}[September 2026 Navier--Stokes announcement]
        ...
        the September 13 cutoff. The precise quiz status is therefore
    ...
    \begin{fact}[Two memorable geometry results from 2025]
        ...
        \begin{itemize}
            \item Work by Nalini Anantharaman and Laura Monk shows that a
                  Weil--Petersson random hyperbolic surface of large genus
    ...
    \begin{fact}[Ten AI-generated research advances]
        ...
        \end{bookitems}
        At the September 13, 2026 cutoff, these remained recently
    ...
    \begin{fact}[Jacob Tsimerman and OpenAI]
        After receiving a 2026 Fields Medal, Jacob Tsimerman announced at the
        2026 ICM that he would begin a position at OpenAI. He went on leave from the
    ...
    \begin{fact}[A 2026 preprint on Thakur's conjecture]
        ...
        remained a preprint at the September 13, 2026 cutoff, its
        status should be
    ...
    \begin{fact}[Korean competition results belong to the competition chapter]
        The Republic of Korea placed third at the 2025 IMO and sixth at the 2026 IMO;
