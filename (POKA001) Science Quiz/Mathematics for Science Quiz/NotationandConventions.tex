    ...
    \begin{longtable}{@{}L{0.24\textwidth}L{0.68\textwidth}@{}}
        ...
        Problem & a mathematical question to be solved \\
        Example & an illustration of a definition, method, or result \\
        Counterexample & an example showing that a statement is false \\
    \end{longtable}
    }

    Labels are set upright. Decimal labels such as $1.1,1.2,\dots$ identify
