    ...
    This chapter records the mathematical events most relevant to the 2026
    Science Quiz season. Its time window begins on January 1, 2025, and runs
    through the preparation cutoff of August 2, 2026. Later developments may be
    added before the competition. Unlike Part II, which collects durable facts
    that should remain useful in future years, this chapter emphasizes why a
    ...
    \begin{fact}[Status language in this chapter]
    ...
    \section*{Prizes and Congresses}

    The prize section in Part II explains the history and general rules of the
    Fields Medal, Abel Prize, and Wolf Prize. The present section records the
    ...
    \section*{Mathematical Competitions}
    ...
    \begin{remark}
        Human competition results belong in this section. Performance by AI
    ...
    \section*{Major Mathematical Developments}

    This section records developments that were prominent during 2025 and 2026.
    ...
    \section*{Artificial Intelligence and Mathematics}
    ...
    \section*{Mathematicians and Institutions}
    ...
    \section*{Mathematics in Korea}

    This section records events whose specifically Korean institutional or
    ...
    \begin{longtable}{@{}L{0.09\textwidth}L{0.24\textwidth}L{0.27\textwidth}L{0.32\textwidth}@{}}
        ...
        & Professor at KIAS and associate professor at the University of California, Berkeley
    ...
    \begin{fact}[Korean competition results belong to the competition section]
