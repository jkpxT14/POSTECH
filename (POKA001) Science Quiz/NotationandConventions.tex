    ...
    codomain of a function, while $x\mapsto f(x)$ specifies the rule assigning an
    element to its image.
    ...
    \begin{longtable}{@{}L{0.27\textwidth}L{0.65\textwidth}@{}}
        ...
        $X\hookrightarrow Y$ & an injective map from $X$ to $Y$, when explicitly stated \\
        $X\twoheadrightarrow Y$ & a surjective map from $X$ to $Y$, when explicitly stated \\
    ...
    \begin{longtable}{@{}L{0.27\textwidth}L{0.65\textwidth}@{}}
        ...
        $f_n\to f$ & pointwise convergence, unless another mode of convergence is stated \\
