    ...
    principle is to use the author's notation first, standard mathematical
    notation second, and source-specific notation only when necessary.
    ...
    ambiguous in fast quiz solutions.
    ...
    item. Statement-type environments such as Definition, Theorem, Proposition,
    Lemma, Corollary, Formula, Fact, Conjecture, Hypothesis, Open Problem, and
    Algorithm put the heading on its own line. Short guide-type environments
    such as Idea, Strategy, Tactic, and Remark continue on the same line after
    the label. Problem, Solution, Proof, and Hint also continue on the same line
    after the label.
    ...
    For logarithms, this book uses $\ln x$, $\lg x$, and $\lb x$ for bases
