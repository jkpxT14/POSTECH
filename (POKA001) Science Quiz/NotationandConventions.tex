    ...
    statements are labeled $(1),\ (2),\ (3),\ldots$. Connected subparts of a single
    problem are labeled $(a),\ (b),\ (c),\ldots$. The decimal labels $1.1,\ 1.2,
    \ 1.3,\ldots$ are reserved for independently movable calculation problems
    grouped under one Direct Calculation Problems category.
    ...
    standard problem name. Internal preparation materials and invented source
    descriptions are not cited in this position; when no qualifying source or
    standard name is known, the attribution is omitted.
