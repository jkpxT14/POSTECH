    ...
    \begin{longtable}{@{}L{0.24\textwidth}L{0.68\textwidth}@{}}
        ...
        $\text{s.t.}$ & such that \\
        $\text{N.t.}$ & Note that \\
        $\eps$ & a positive real number used in analysis, usually arbitrarily small \\
    ...
    in ordinary prose when a logical formula is not being displayed.
    ...
    \begin{longtable}{@{}L{0.27\textwidth}L{0.65\textwidth}@{}}
        ...
        $\indicator{A}(x)$ & the indicator function, or characteristic function, of $A$ \\
        $\aleph_0$ & the cardinality of a countably infinite set \\
        $\mathfrak{c}$ & the cardinality of the continuum \\
    \end{longtable}
    }

    The indicator function is written as $\indicator{A}$; the all-ones vector is
    $\ones$. Boldface is reserved for vectors and matrices.
    ...
    \begin{longtable}{@{}L{0.27\textwidth}L{0.65\textwidth}@{}}
        ...
        $\Real z$ or $\Re z$, $\Imag z$ or $\Im z$ & the real and imaginary parts of $z$ \\
