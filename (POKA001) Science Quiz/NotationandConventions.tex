    ...
    as Definition, Theorem, Formula, and Algorithm put the heading on its own
    line, while short guide-type environments such as Idea, Strategy, Tactic,
    and Remark continue on the same line after the label.
