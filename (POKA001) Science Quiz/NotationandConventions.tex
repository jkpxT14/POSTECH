    ...
    used in ordinary prose. When several equivalent notations are listed in the
    same table entry, the first notation is the convention used in this book; the
    later forms are included only to identify common alternatives that a reader
